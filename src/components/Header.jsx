...
const Header = () => {
	return (
		<header className="flex justify-between items-center flex-col text-center sm:max-w-xl lg:max-w-full lg:py-0 max-w-xs mx-auto rounded-md sm:pt-10 lg:mt-24">
